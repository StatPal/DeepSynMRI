...
class Downsampler(nn.Module):
    ...
    def __init__(self, n_planes, factor, kernel_type, phase=0, kernel_width=None, support=None, sigma=None, preserve_size=False):
        ...
        downsampler = nn.Conv3d(n_planes, n_planes, kernel_size=self.kernel.shape, stride=factor, padding=0)
        ...
        if preserve_size:
            ...
            self.padding = nn.ReplicationPad3d(pad)
...
# KS = 32
# dow = nn.Sequential(nn.ReplicationPad3d(int((KS - factor) / 2.)), nn.Conv3d(1,1,KS,factor))
